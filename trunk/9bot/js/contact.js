...
var shopNameArr	=	["New Moving Società Cooperativa","Energeco s.r.l.","Only Multimedia","E-Wheels","Super Ground","Alpi Graie srl","Maxi Sport snc","Style by Stefano Valloncini","Berica Motors","Faber Soft","Travel for fun","Magic Video","Emobility","Mc Motors Srl","Eye, Eye, Sir! Snc","ON LINE","La Bicicletteria Italiana","Cicli Salieri","Sicily Rent Segway","Zanichelli Paolo","DOMUSROBOTICA","è-Motion","Garda Yachting Charter"];
var addArray	=	["Via di San Calisto 9 Roma 00153 RM","Vicolo di Dragone,1, Roma, 00126 RM","Via Carducci,14, Merano, 39012 BZ","Via Chambery,139, Aosta, 11100 AO","Via Dionigi Bussola,4, Milano, 20143 MI","Via Vajont,69, Rivoli, 10098 TO","Via Vittorio Veneto,9, 24060 Rogno,BG","Via Sole delle Alpi,48, 25030 TORBIATO DI ADRO, BS","Via Tagliamento,6, Schio, 36016 VI","Piazzale Giacomo Matteotti,21, Fabriano, 60044 AN","Via Montenuovo Licola Patria,90, 80078 Pozzuoli, NA","Via Edoardo Alagna,62, Marsala, 91025 TP","Matera, Basilicata","Viale della Repubblica,37, 73100 Lecce, LE","Via Salvo D'Acquisto,15, Colombare Di Sirmione, 25019 BS","Corso Garibaldi 248, Napoli, 8041 NA","Via Crispi 86, Arezzo, 52100 AR","Via Reggio Emilia,6/C/D/E, Bologna, 40139 BO","Via Vittorio Emanuele,203,95124 Catania CT","Via Val d'Enza, 35, 42049 - Sant'Ilario d'Enza (RE)","di Vannini Giuseppe Via Liguria 5, 42028 Poviglio RE","Via Camozzi 11/c 25125 Brescia","Lungolago Zanardelli 33 25087 Toscolano Maderno"];
var emailArr	=	["Ninebot.servizioclienti@gmail.com","info@energeko.it","info@onlymultimedia.it","info@ewheelsaosta.it","produzione@superground.it","info@alpigraie.com","poletti.paolo1@gmail.com","info@styleliving.it","ame2712@alice.it","amministrazione@fabersoft.it","info@puteoliforfun.it","magicvideomarsala@yahoo.it","bellisariocarlucci@libero.it","servizioclienti@kialecce.it","info@eyeeyesir.com","vincenzosorrentinoonline@gmail.com","personaltransporter@yahoo.it","ciclisalieri@gmail.com","sicilyrentsegway@hotmail.it","zanichelli_paolo@virgilio.it","info@vanninigiuseppe.it","info@emotion-rentalcar.com","info@gyc.it"];
var websiteArr	=	["","www.energeko.it/","www.onlymultimedia.it/","www.ewheelsaosta.it/","","","","www.styleliving.it/","","www.fabersoft.it/","","www.magicvideomarsala.it","","www.kialecce.it/index.aspx","","www.onlinesorrentino.it/","www.labicicletteriaitaliana.it/index.html","","www.sicilyrentsegway.it/","","www.domusrobotica.it/", "", ""];
var phoneArr	=	["39 29 034 927 ","06 89169378; 346 3896433","04 732 10 553","01 65361022; 347 9024039","340 732 1131; 028 907 0527","","035 96 76 10","030 73 56 325","044 458 2529","073 26 29 295, 073 22 86 121","081 196 69 008","092 39 56 962","328 43 27 215","083 23 32 351","347 47 82 344","081 21 10 858; 081 76 44 872","392 76 48 376","051 45 39 64","09 52272430; 09 55876150; 344 0681727","0522 672571","3482308317"," 030/7777911; 333/3741073","0365/548347; 333/3741073"];
...
window.onload = function(){
	for(i=1;i<addArray.length;i++){
	  	//allLocationString += '<div class="locationInfoContainer"><div class="headingTripInfo">'+shopNameArr[i]+'</div><div class="locationMapInfo"><div class="mapContainer"><div class="uniqueMap" id="LocMap'+i+'"></div></div></div><div class="DesciptionTripInfo">'+addArray[i]+'</div><div class="DurationTripInfo">'+emailArr[i]+'<br />'+phoneArr[i]+'</div></div>'
	  	allLocationString += '<div class="locationInfoContainer"><div class="headingTripInfo">'+shopNameArr[i]+'</div><div class="DesciptionTripInfo">'+addArray[i]+'</div><div class="DurationTripInfo">'+emailArr[i]+'<br />'+phoneArr[i]+'</div><div class="DurationTripInfo"><a href="http://'+websiteArr[i]+'" target="_blank">'+websiteArr[i]+'</a></div></div>'
	}
