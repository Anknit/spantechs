...
var websiteArr	=	["","www.energeko.it/","www.onlymultimedia.it/","www.ewheelsaosta.it/","","","","www.styleliving.it/","","www.fabersoft.it/","","www.magicvideomarsala.it","","www.kialecce.it/index.aspx","","www.onlinesorrentino.it/","www.labicicletteriaitaliana.it/index.html","","www.sicilyrentsegway.it/","","www.domosrobotica.it/", "", ""];
...
window.onload = function(){
	for(i=1;i<addArray.length;i++){
	  	...
	  	allLocationString += '<div class="locationInfoContainer"><div class="headingTripInfo">'+shopNameArr[i]+'</div><div class="DesciptionTripInfo">'+addArray[i]+'</div><div class="DurationTripInfo">'+emailArr[i]+'<br />'+phoneArr[i]+'</div><div class="DurationTripInfo"><a href="http://'+websiteArr[i]+'">'+websiteArr[i]+'</a></div></div>'
	}
