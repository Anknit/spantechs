...
?>
	...
	<div class="content">
		...
		<div class="HITcontentSection">
        	<h2>Batteria Standard</h2>
			<div class="HITcontentProductDescription">
            	<p>
                	<span style="font-size:20px">Batteria per Ninebot 55.5V 450Wh.  Autonomia dichiarata: 25-30Km. Tempi di Ricarica: 3-4Ore</span>
                	<br />
                	<br />
                	Costo: € 600 + IVA
				</p>
		...
		<div class="HITcontentSection">
        	<h2>Batteria Lunga percorrenza</h2>
			<div class="HITcontentProductDescription">
            	<p>
                	<span style="font-size:20px">Autonomia dichiarata 45-50 km.</span>
                	<br />
                	<br />
                	Costo: € 800 + IVA
				</p>
		...
		<div class="HITcontentSection">
        	<h2>Barra per guida a mani libere (Handless lever)</h2>
			<div class="HITcontentProductDescription">
            	<p>
                	<span style="font-size:20px">La barra di guida posizionata tra le ginocchia è montata al posto del manubrio Ninebot, consentendo una piacevole guida a mani libere.</span>
                	<br />
                    Ideale per: Riprese video e Fotografia.
                	<br />
                	Costo: € 106 + IVA
				</p>
            </div>
		...
		<div class="HITcontentSection">
        	<h2>Barra lunga 104 cm</h2>
			<div class="HITcontentProductDescription">
            	<p>
                	<span style="font-size:20px">Consigliata per sostituire la barra standard per utenti di altezza da 1,80 metri a 2,1 metri.</span>
                	<br />
                	<br />
                	Costo: € 70 + IVA
				</p>
		...
		<div class="HITcontentSection">
        	<h2>Barra corta 79 cm</h2>
			<div class="HITcontentProductDescription">
            	<p>
                	<span style="font-size:20px">Consigliata per sostituirla barra standard per utenti di altezza 1,3 metri a 1,8 metri.</span>
                	<br />
                	<br />
                	Costo: € 70 + IVA
				</p>
		...
		<div class="HITcontentSection">
			...
			<div class="HITcontentProductDescription">
            	<p>
                	<span style="font-size:20px">La borsa Ninebot originale in colore grigio da collocare al piantone dello sterzo. La presenza di un morsetto consente la sua facile rimozione.</span>
                	<br />
                	<br />
                	Costo: € 60 + IVA
				</p>
		...
		<div class="HITcontentSection">
        	<h2>Borsa con Speaker Bluetooth</h2>
			<div class="HITcontentProductDescription">
            	<p>
                	<span style="font-size:20px"></span>
                	<br />
			...
			<div class="HITcontentProductDescription">
            	<p>
                	<span style="font-size:20px">
                        I telaio Cargo sono in grado di ospitare tutti i raccordi per montare borse o altro e
                        Sono la base per un uso multifunzionale del Ninebot E.
                        Le maniglie integrate permettono di sollevare ancor più agevolmente il Ninebot.
                        Sono verniciati a polvere bianca e realizzati in lamiera di alluminio di 4 mm, collegabili al Ninebot mediante 3 viti nei lati interni del parafango.
                        Ogni dotazione comprende 2 supporti.
                     </span>
                	<br />
                	<br />
                	Costo: € 150 + IVA
		...
		<div class="HITcontentSection">
        	<h2>Parafango Bianco</h2>
			<div class="HITcontentProductDescription">
            	<p>
                	<span style="font-size:20px">Ogni dotazione comprende 2 pezzi</span>
                	<br />
                	<br />
                	Costo: € 70 + IVA
				</p>
		...
		<div class="HITcontentSection">
        	<h2>Caricabatteria bianco</h2>
			<div class="HITcontentProductDescription">
            	<p>
                	<span style="font-size:20px">Alimentatore Ninebot 130W. Tempo di ricarica 3 ore.</span>
                	<br />
                	<br />
                	Costo: € 80 + IVA
				</p>
		...
		<div class="HITcontentSection">
        	<h2>Caricabatteria nero</h2>
			<div class="HITcontentProductDescription">
            	<p>
                	<span style="font-size:20px">Alimentatore Ninebot 130W. Tempo di ricarica completa in 3 ore.</span>
                	<br />
                	<br />
                	Costo: € 80 + IVA
				</p>
		...
		<div class="HITcontentSection">
        	<h2>Ruota completa Bianca</h2>
			<div class="HITcontentProductDescription">
            	<p>
                	<span style="font-size:20px">Ruota di Ricambio per Ninebot comprensiva di Cerchio e Copertone</span>
                	<br />
                	<br />
                	Costo: € 100 + IVA
				</p>
		...
		<div class="HITcontentSection">
        	<h2>Cavalletto di Ricambio per Ninebot</h2>
			<div class="HITcontentProductDescription">
            	<p>
                	<span style="font-size:20px"></span>
                	<br />
		...
		<div class="HITcontentSection">
        	<h2>Impugnatura di Ricambio per Ninebot</h2>
			<div class="HITcontentProductDescription">
            	<p>
                	<span style="font-size:20px">Ogni dotazione comprende 2 pezzi</span>
                	<br />
		...
		<div class="HITcontentSection">
        	<h2>Telecomando Aggiuntivo per Ninebot</h2>
			<div class="HITcontentProductDescription">
            	<p>
                	<span style="font-size:20px"></span>
                	<br />
		...
		<div class="HITcontentSection">
        	<h2>Porta bottiglia</h2>
			<div class="HITcontentProductDescription">
            	<p>
                	<span style="font-size:20px">Montato sul manubrio può essere adattato a bottiglie di diverse dimensioni.</span>
                	<br />
                	<br />
                	Costo: € 10 + IVA
				</p>
		...
		<div class="HITcontentSection">
			...
			<div class="HITcontentProductDescription">
            	<p>
                	<span style="font-size:20px">Completo di guarnizioni in diversi colori. </span>
                	<br />
                	<br />
                	Costo: € 50 + IVA
				</p>
		...
		<div class="HITcontentSection">
			...
			<div class="HITcontentProductDescription">
            	<p>
                	<span style="font-size:20px">
                    	La luce LED su tecnologia SMD, garantisce la massima luminosità e bassissimo consumo energetico.<br />
                        Inserita direttamente nella porta USB nel manubrio. <br />
                        Accensione mediante sfioramento. Regolazione intensità variabile.<br />
                        Specifiche: 1 watt, 5 volt
                    </span>
                	<br />
                	<br />
                	Costo: € 15 + IVA
		...
		<div class="HITcontentSection">
        	<h2>Faro impermeabile</h2>
			<div class="HITcontentProductDescription">
            	<p>
                	<span style="font-size:20px">
                    	Un accessorio necessario per l’uso del Ninebot dopo il tramonto.
						<br />Potenza 850 lumen. Batteria esterna al litio 40Wh.
                    </span>
                	<br />
                	<br />
                	Costo: € 40 + IVA
		...
		<div class="HITcontentSection">
        	<h2>Coprimozzo ruota decorativi</h2>
			<div class="HITcontentProductDescription">
            	<p>
                	<span style="font-size:20px">Completo 2 pezzi.</span>
                	<br />
                	<br />
                	Costo: € 20 + IVA
				</p>
		...
		<div class="HITcontentSection">
        	<h2>Panello fontale in plexiglass</h2>
			<div class="HITcontentProductDescription">
            	<p>
                	<span style="font-size:20px"></span>
                	<br />
		...
		<div class="HITcontentSection">
        	<h2>Pannello frontale con scritta luminosa, dinamica e programmabile da PC</h2>
			<div class="HITcontentProductDescription">
            	<p>
                	<span style="font-size:20px"></span>
                	<br />
