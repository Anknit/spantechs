...
?>
    <title>NINEBOT E POLICE</title>
    <link type="text/css" rel="stylesheet" href='../../css/ProdottiLayouts.css' />
	<div class="content">

		<div>
            <div style="text-align:center;width: 70%; margin: auto;">
        	   <h2 style="border-bottom:1px solid #b4bbbf">Ninebot E Police</h2>
            </div>
            <div style="text-align:center;width:80%;margin:auto;background: linear-gradient(to bottom right, #C1C1C1 , #E1E5F0);">
